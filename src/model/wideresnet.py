...
class WideResNet(nn.Module):
    def __init__(self, config): #, depth, num_classes, widen_factor=1, dropRate=0.0):
...
if __name__ == '__main__':
    ...
    config = { "model": { "widen_factor": 1, "dropRate": 0, "depth": 28 } }
    print(config)
    net=WideResNet(EasyDict(config))
    y = net(Variable(torch.randn(1,3,128,128)))
